...
from netsim.logger.netsim_logging_manager import LoggingManager, log_with_tag
...
if __name__ == "__main__":
    mp.set_start_method("fork")  # or "spawn" if on Windows
    main()
